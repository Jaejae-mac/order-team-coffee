 ...
 * 화면 우하단 플로팅 버튼 그룹
 * - 게임 버튼은 항상 표시
 * - "+" 버튼 클릭 시 투표/커피주문 메뉴가 위에서 슬라이드되고,
 *   게임 버튼이 자연스럽게 위로 밀리며 스택됨
 */
"use client";

import { useState } from "react";
import { Plus, Coffee, Gamepad2 } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 flex flex-col items-end gap-3 z-30">
        ...
        {/* ── 게임 버튼 — 항상 표시, 메뉴 열리면 자연스럽게 위로 밀림 ── */}
        <button
